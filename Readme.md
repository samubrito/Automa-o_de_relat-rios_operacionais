...
<p align="center">
  <img src="imagens/automacao_relatorios.png" alt="Automação de Consolidação: Relatório Operacional Logístico" width="400px">
</p>
...
<p align="center">
  <img src="imagens/tabela_exemplo.png" alt="Tabela Excel" width="800px">
</p>
...
```bash
pip python automacao_de_consolidacao.py
```
